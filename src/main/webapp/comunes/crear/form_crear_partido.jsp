            ...
            <div class="div-form-crear-partido">
                ...
                <div class="div-buscarId-jugador">
                    <form action="ServletCrear" method="get">
                        ...
                        <select class="aspecto-select" name="cbo_id_pares">
                            <option value=" --- "> --- </option>
                ...
                <form action="ServletCrear" method="post">
                 ...
                 <input type="date" name="txt_fecha" min="2000-01-01" max="2050-01-01" required/>
                    ...
                    <div class="div-select-jugador">
                        <label for="cbo_jugador1">Jugador1</label>
                        <select class="aspecto-select ancho-select" id="select_j1" name="cbo_jugador1" onchange="ir(this.value, 'select_j1')">
                            <c:set var="pares" value="${obj_pares}"/>
                            <c:if test="${pares != null}">
                                <option class="aspecto-select-option" value=${pares.idJ1}>${pares.idJ1} - ${pares.nombreJ1}</option>
                            </c:if>
                            <c:if test="${pares == null && jugador1 == null}">
                                <option class="aspecto-select-option" value=" --- "> --- </option>
                                <c:forEach var="ju" items="${lista_jugadores}">
                                    <option class="aspecto-select-option" value="${ju.id}">${ju.id} - ${ju.nombre}</option>  
                                </c:forEach>
                            </c:if>
                            <c:if test="${jugador1 != null}">
                                <option class="aspecto-select-option" value=${jugador1.id}>${jugador1.id} - ${jugador1.nombre}</option>
                            </c:if>
                        </select>
                    </div>
                            ...
                            <div class="div-select-jugador">
                                ...
                                <select class="aspecto-select ancho-select" id="select_j2" name="cbo_jugador2" onchange="ir(this.value, 'select_j2')" >
                                    <c:set var="pares" value="${obj_pares}"/>
                                    <c:if test="${pares != null}">
                                        <option class="aspecto-select-option" value=${pares.idJ2}>${pares.idJ2} - ${pares.nombreJ2}</option>
                                    </c:if>
                                    ...
                                    <c:if test="${jugador2 != null}">
                                        <option class="aspecto-select-option" value=${jugador2.id}>${jugador2.id} - ${jugador2.nombre}</option>
                                    </c:if>
                                </select>
                            </div>

                                    <div class="div-paga-jugador">
                                        <label>Paga- j1</label>
                                        <select class="aspecto-select ancho-select" name="cbo_paga1"> 
                                            <c:set var="bonosj1" value="${bonosj1}"/>
                                            <c:if test="${bonosj1 != null}">
                                                <c:forEach var="bono" items="${bonosj1}"> 
                                                    <option class="aspecto-select-option" value=${bono.id}>id:${bono.id} - Horas:${bono.horas}</option>
                                                </c:forEach> 
                                            </c:if> 
                                            <c:if test="${bonosj1 == null}">
                                                <option class="aspecto-select-option" value="no">No</option>
                                                <option class="aspecto-select-option" value="si">Si</option>
                                            </c:if>
                                        </select>
                                    
                                            <div class="alinear-bloque">
                                                <label>Horas</label>
                                                <select class="aspecto-select" name="cbo_horas_p1">
                                                    <option class="aspecto-select-option" value="0">0</option>
                                                    <option class="aspecto-select-option" value="1">1</option>
                                                    <option class="aspecto-select-option" value="2">2</option>
                                                </select>
                                            </div> 
                                            ...
                                            <div class="div-paga-jugador">
                                                <label>Paga- j2</label>
                                                <select class="aspecto-select ancho-select" name="cbo_paga2">  
                                                    ...
                                                    <div class="alinear-bloque">
                                                        <label>Horas</label>
                                                        <select class="aspecto-select" name="cbo_horas_p2">
                                                            <option class="aspecto-select-option" value="0">0</option>
                                                            <option class="aspecto-select-option" value="1">1</option>
                                                            <option class="aspecto-select-option" value="2">2</option>
                                                        </select>
